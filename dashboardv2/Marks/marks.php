...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO `markss` (marks_Id ,Stu_Id ,Maths, JAVA, C_lan, Cplusplus) VALUES (NULL,'$Stu_Id','$Maths','$JAVA','$C_lan','$Cplusplus') WHERE Stu_Id= $Stu_Id ";
            ...
            <tbody class="table-group-divider">
                    ...
                    ?>
                               ...
                               <tr>
                                    ...
                                    <td>
                                    <a href="marks.php?Stu_Id=<?php echo $row['Stu_Id']?>" class="link-dark" data-bs-toggle="modal" data-bs-target="#marksupdmodal"> <i class="fa-solid fa-pen-to-square fs-5 me-3"></i> </a>
                        ...
                        <form action="" method="post" style="width:50vw; min-width:300px; " id="marks-form">
                            <div class="row">
                                <div class="Center" style=" margin-bottom: 50px; ">
                                    ...
                                    $sql = "INSERT INTO `markss` (marks_Id ,Stu_Id ,Maths, JAVA, C_lan, Cplusplus) VALUES (NULL,'$Stu_Id','$Maths','$JAVA','$C_lan','$Cplusplus') WHERE Stu_Id= ". $_GET['Stu_Id'];
                                    ?>
