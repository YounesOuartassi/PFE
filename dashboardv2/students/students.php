...
if (isset($_POST['update'])) {
    ...
    $sql2 = "UPDATE students SET `First_name`='$First_name',`Last_name`='$Last_name',`Phone_num`='$Phone_num',`Email`='$Email' WHERE Stu_Id =" . $_GET['Stu_Id'];
    ...
    <div class="d-flex" id="wrapper">
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                ...
                <a href="students.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="add-container " style="margin-top: 20px; margin-left: 27px;">
                <?php
                if (isset($_GET['msg'])) {
                    $msg = $_GET['msg'];
                ...
                ?>
                <a class="btn btn-dark mb-4" data-bs-toggle="modal" data-bs-target="#staticBackdrop"> Add new Student</a>
                    ...
                    <tbody class="table-group-divider">
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a href="students.php?Stu_Id=<?php echo $row['Stu_Id']?>" class="link-dark" data-bs-toggle="modal" data-bs-target="#staticBackdrop2"> <i class="fa-solid fa-pen-to-square fs-5 me-3"></i> </a>
                                    <a href="../students/stu-del.php?Stu_Id=<?php echo $row['Stu_Id'] ?>" class="link-dark"> <i class="fa-solid fa-trash fs-5 "></i> </a>
            ...
            <div class="modal fade modal-lg" id="staticBackdrop2" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="staticBackdropLabel">Edit Student Informations</h1>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
